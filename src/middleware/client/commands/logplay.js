...
const commands = {
    play: {
        ...
        description: "Sends log file back to client based on timestamps.",
    ...
    stop: {
        syntax: "stop",
        description: "Stops the playing if it is",
        func: (data, middleware, linkedMiddleware, statusOfState) => {
            if (!statusOfState) {
    ...
    pause: {
        syntax: "pause",
        description: `Pauses the current playing log, <logplay resume> or <logplay play> should resume it`,
        func: (data, middleware, linkedMiddleware, statusOfState) => {
            if (!statusOfState) {
                data.respond.push("Nothing is playing.");
    ...
    resume: {
        syntax: 'resume',
        description: "resumes if anything paused",
        func: (data, middleware, linkedMiddleware, statusOfState) => {
    ...
    speed: {
        syntax: "speed <number>",
        description: "Changes playing speed of the log, integer or floating number both accepted",
        func: (data, middleware, linkedMiddleware, statusOfState) => {
    ...
    seek: {
        syntax: "seek <number>",
        description: "Sets the playing log to given number",
